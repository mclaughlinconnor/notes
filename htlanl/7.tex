...
The \mintinline{python}{len()} function can be used to find the number of items in a list. eg. \mintinline{python}{len([1, 2, 3, 4, 5, 6]) == 6}.
...
All list-like objects can be sliced to access a subsequence of the original using \mintinline{python}{items[start:end:step]} which works on lists, strings, tuples, etc.
