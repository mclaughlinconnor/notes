...
\begin{note}
	\begin{itemize}
		\item[] In most old languages (like C, C++), booleans are often represented by just a \(1\) or  \(0\).
...
\begin{note}
	\begin{itemize}
		\item[] When describing a theory or model, use present tense since the theory or model is still the same.
